...
import { faPhone, faUniversity, faSave, faTimes , faUsers, faDirections, faIdCard, faHome, faBackspace, faQuoteLeft, faArrowLeft} from '@fortawesome/free-solid-svg-icons';
...
export class EmployeeFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.activatedRoute.params.subscribe( params =>{
      if(params['id']){
        this.employeeService.retrieve(params['id'])
          .subscribe(result =>
            {
